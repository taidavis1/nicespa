        ...
        <section className="relative overflow-x-hidden">
            <div className="w-screen bg-pageb lg:bg-pagel bg-no-repeat lg:bg-center bg-cover h-screen relative">
                <Fade cascade delay={150}>
                    <div className="absolute lg:top-1/3 lg:right-12 top-1/3 w-full px-3 py-5 space-y-6 lg:py-8 md:space-y-12 text-center">
                        <div className="">
                        ...
                        <div className="flex justify-center italic">
                            <ul className=" text-white font-Marcok font-bold uppercase space-y-2">
                                <li>
                        ...
                        <button onClick={
                            AppointmentBtn
                        } className="hover:bg-white rounded-full md:text-xl text-white md:bg-white/0 bg-black/80 text-lg py-3 group cursor-pointer px-12 md:border-2 md:border-white md:tracking-wide">
            ...
            <Fade>
                <div className="flex justify-center p-4 mt-4 mb-5">
                    <button onClick={(e) => {e.preventDefault(); window.open('/SocialTree' ,'_blank')}} className="shadow-lg hover:bg-black hover:text-white hover:-translate-y-1 border-black border-2 text-black px-12 py-5 font-Lora text-xl">Leave Us A Honest Review And Get $50 off</button>
                </div>
            </Fade>
            <Slide>
